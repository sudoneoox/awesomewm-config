...
core_deps="nitrogen rofi polybar network-manager-applet pulseaudio pa-applet-git blueman i3lock-color xautolock scrot maim cbatticon xbacklight light brightnessctl pulseaudio-bluetooth clipmenu pywal networkmanager-dmenu calc thunar htop"
